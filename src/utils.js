...
export const showModal = (html, data) => {
  appEvents.emit('show-modal', {
    src: 'public/plugins/smart-factory-operation-crud-table-panel/partials/' + html,
...
export const findOperationByName = (operations, key) => {
  return operations.filter(operation => operation.name === key)
}
